...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo CSS_URL; ?>/content.css">
...
<body>
	...
	<header>
		<div class="topBar">
			<div class="center">
				<div class="left">
					<img src="<?php echo IMG_URL; ?>/icon/shoucang.jpg" class="shoucang" height="14" width="15">
					<a href="#">收藏本网站</a>
				</div>
				<div class="right">
					<span>欢迎来到XX网!</span>
			...
			<div class="center">
				<div class="middle">
					<div class="midBar_logo">
						<img src="<?php echo IMG_URL; ?>/icon/logo.png" class="img-circle logo" height="75" width="75">
					</div>
					...
					<div class="midBar_shopcar">
						<div class="shopcar">
							<img src="<?php echo IMG_URL; ?>/icon/shopcar.png" class="img-rounded " height="46" width="50">
		...
		<div class="content">
			...
			<div class="shopShow">
				...
				<div id="shopMath">
					<div class="shopDetail" id="math">
						<dl class="shopDetail_item" >
							<dt><a href="#">数学</a><span class="badge hot pull-right"> HOT</span><img class="jiantou" src="<?php echo IMG_URL; ?>/icon/jiantou.jpg" height="8" width="5"></dt>
					...
					<div class="showDetail" id="showMath">
						<div class="detaile_left">
							<dl id="math1">
								<dt><img src="<?php echo IMG_URL; ?>/icon/math1.png" alt="math1" height="30" width="30"><a href="#">小学数学</a><hr class="hr"></dt>
								<dd><a href="#">一至三年级</a><a href="#">四至六年级</a><a href="#">小学奥数</a><a href="#">教参辅导</a></dd>
							</dl>
							<dl id="math2">
								<dt><img src="<?php echo IMG_URL; ?>/icon/math2.png" alt="math2" height="30" width="30"><a href="#">中学数学</a><hr class="hr"></dt>
								<dd><a href="#">初中数学</a><a href="#">高中数学</a><a href="#">初中教辅</a><a href="#">高中教辅</a><br><a href="#">初中习题册</a><a href="#">高中习题册</a></dd>
							</dl>
							<dl id="math3">
								<dt><img src="<?php echo IMG_URL; ?>/icon/math3.png" alt="math3" height="30" width="30"><a href="#">大学数学</a><hr class="hr"></dt>
								<dd><a href="#">高等数学</a><a href="#">离散数学</a><a href="#">线性代数</a><a href="#">概率论</a><br><a href="#">复变函数</a></dd>
							</dl>
						</div>
						<div class="detaile_right">
							<img src="<?php echo IMG_URL; ?>/lunbo/math4.jpeg" class="detaile_right_img" alt="math4" height="390" width="200">
						</div>
					</div>
				</div>
				...
				<div id="shopEng">
					<div class="shopDetail" id="english">
						<dl class="shopDetail_item">
							<dt><a href="#">英语</a> <span class="badge hot pull-right"> HOT</span><img class="jiantou" src="<?php echo IMG_URL; ?>/icon/jiantou.jpg" height="8" width="5"></dt>
					...
					<div class="showDetail" id="showEng">
						<div class="detaile_left">
							<dl id="eng1">
								<dt><img src="<?php echo IMG_URL; ?>/icon/eng1.png" alt="eng1" height="30" width="30"><a href="#">小学英语</a><hr class="hr"></dt>
								<dd><a href="#">英语教材</a><a href="#">口语学习</a><a href="#">课外练习</a><a href="#">教参辅导</a></dd>
							</dl>
							<dl id="eng2">
								<dt><img src="<?php echo IMG_URL; ?>/icon/eng2.png" alt="math2" height="30" width="30"><a href="#">中学英语</a><hr class="hr"></dt>
								<dd><a href="#">初中英语</a><a href="#">高中英语</a><a href="#">初中教辅</a><a href="#">高中教辅</a><br><a href="#">初中习题册</a><a href="#">高中习题册</a></dd>
							</dl>
							<dl id="eng3">
								<dt><img src="<?php echo IMG_URL; ?>/icon/eng3.png" alt="eng3" height="30" width="30"><a href="#">大学英语</a><hr class="hr"></dt>
								<dd><a href="#">英语教材</a><a href="#">托福英语</a><a href="#">雅思英语</a><a href="#">四级</a><br><a href="#">六级</a><a href="#">口语练习</a></dd>
							</dl>
						</div>
						<div class="detaile_right">
							<img src="<?php echo IMG_URL; ?>/lunbo/eng4.jpeg" class="detaile_right_img" alt="eng4" height="351" width="180">
						</div>
					</div>
				</div>
				...
				<div id="shopNov">
					<div class="shopDetail">
						<dl class="shopDetail_item" id="novel">
							<dt><a href="#">文学</a><a href="#">小说</a><img class="jiantou" src="<?php echo IMG_URL; ?>/icon/jiantou.jpg" height="8" width="5"></dt>
					...
					<div class="showDetail" id="showNov">
						<div class="detaile_left">
							<dl id="nov1">
								<dt><img src="<?php echo IMG_URL; ?>/icon/nov1.png" alt="nov1" height="30" width="30"><a href="#">武侠小说</a><hr class="hr"></dt>
								<dd><a href="#">金庸专区</a><a href="#">古龙专区</a><a href="#">黄易专区</a><a href="#">其他作者</a></dd>
							</dl>
							<dl id="nov2">
								<dt><img src="<?php echo IMG_URL; ?>/icon/nov2.png" alt="nov2" height="30" width="30"><a href="#">网络小说</a><hr class="hr"></dt>
								<dd><a href="#">唐家三少</a><a href="#">天蚕土豆</a><a href="#">我吃西红柿</a><a href="#">辰东</a><br><a href="#">忘语</a><a href="#">血红</a></dd>
							</dl>
							<dl id="nov3">
								<dt><img src="<?php echo IMG_URL; ?>/icon/nov3.png" alt="nov3" height="30" width="30"><a href="#">文学名著</a><hr class="hr"></dt>
								<dd><a href="#">中国文学名著</a><a href="#">国外文学名著</a><a href="#">四大名著</a><a href="#">短篇</a><br><a href="#">长篇名著</a></dd>
							</dl>
						</div>
						<div class="detaile_right">
							<img src="<?php echo IMG_URL; ?>/lunbo/nov4.jpeg" class="detaile_right_img" alt="nov4" height="390" width="200">
						</div>
					</div>
				</div>
				...
				<div id="shopTech">
					<div class="shopDetail">
						<dl class="shopDetail_item" id="tech">
							<dt><a href="#">专业知识</a><img class="jiantou" src="<?php echo IMG_URL; ?>/icon/jiantou.jpg" height="8" width="5"></dt>
					...
					<div class="showDetail" id="showTech">
						<div class="detaile_left">
							<dl id="tech1">
								<dt><img src="<?php echo IMG_URL; ?>/icon/tech1.png" alt="tech1" height="30" width="30"><a href="#">计算机语言</a><hr class="hr"></dt>
								<dd><a href="#">Java</a><a href="#">C</a><a href="#">C++</a><a href="#">PHP</a></dd>
							</dl>
							<dl id="tech2">
								<dt><img src="<?php echo IMG_URL; ?>/icon/tech2.png" alt="tech2" height="30" width="30"><a href="#">前端相关</a><hr class="hr"></dt>
								<dd><a href="#">HTML</a><a href="#">CSS</a><a href="#">JavaScript</a><a href="#">Jquery</a><br><a href="#">Bootstrap</a><a href="#">Node.js</a></dd>
							</dl>
							<dl id="tech3">
								<dt><img src="<?php echo IMG_URL; ?>/icon/tech3.png" alt="tech3" height="30" width="30"><a href="#">后端相关</a><hr class="hr"></dt>
								<dd><a href="#">My Sql</a><a href="#">Sql Server</a><a href="#">PHP</a></dd>
							</dl>
						</div>
						<div class="detaile_right">
							<img src="<?php echo IMG_URL; ?>/lunbo/tech4.jpeg" class="detaile_right_img" alt="tech4" height="390" width="200">
						</div>
					</div>
				</div>
				...
				<div id="shopOther">
					<div class="shopDetail">
						<dl class="shopDetail_item" id="other">
							<dt><a href="#">其他书籍</a><img class="jiantou" src="<?php echo IMG_URL; ?>/icon/jiantou.jpg" height="8" width="5"></dt>
							<dd><a href="#">各种其他</a></dd>
						</dl>
					</div>
					<div class="showDetail" id="showOther">
						<img src="<?php echo IMG_URL; ?>/lunbo/qidai.png" alt="qidai" height="380" width="580">
					</div>
				</div>
			</div>
			<!--图片轮播-->
			<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="1500">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="<?php echo IMG_URL; ?>/lunbo/ad4.jpg" height="380" width="580" alt="First slide">
						<div class="carousel-caption">
							<h1>尝试功能</h1>
						</div>
					</div>
					<div class="item">
						<img src="<?php echo IMG_URL; ?>/lunbo/ad2.jpg" height="380" width="580" alt="Second slide">
						
					</div>
					<div class="item">
						<img src="<?php echo IMG_URL; ?>/lunbo/ad3.jpg" height="400" width="600"  alt="Third slide">
					</div>
					<div class="item">
						<img src="<?php echo IMG_URL; ?>/lunbo/ad1.jpg" height="433" width="600"  alt="Four slide">
					</div>
				</div>
				<!-- 轮播（Carousel）导航 -->
			...
			<div class="introduce-ad">
				<a href="<?php echo AD_URL; ?>">
					<img src="<?php echo IMG_URL; ?>/lunbo/ad5.jpg" height="380" width="190" alt="guanggao">
				</a>
			</div>
			<!--热门推荐板块-->
						...
						<div id="recommend_tab_content" class="tab-content">
							<div class="tab-pane fade in active" id="one">
								<div class="recommend_book">
									<img src="<?php echo IMG_URL; ?>/book/haoduo.jpg" class="recommend_book_img" alt="haoduo" height="200" width="130">
								...
								<div class="recommend_book">
									<img src="<?php echo IMG_URL; ?>/book/none2.jpg" class="recommend_book_img" alt="暂无图片" height="200" width="130">
		...
		<div class="footer">
			...
			<div class="footer_info">
				<ul class="footer_info_ul">
					<li>
						<h3><img src="<?php echo IMG_URL; ?>/icon/xinshou.jpg" alt="xinshou" class="img-circle foot_img" height="20" width="20">新手上路</h3>
					</li>
					<p><a href="#">购物流程</a></p>
					<p><a href="#">出售流程</a></p>
					<p><a href="#">常见问题</a></p>
				...
				<ul class="footer_info_ul">
					<li>
						<h3><img src="<?php echo IMG_URL; ?>/icon/baohu.jpg" alt="baohu" class="img-circle foot_img" height="20" width="20">购物保障</h3>
					</li>
					<p><a href="#">卖家认证</a></p>
					<p><a href="#">中介保护</a></p>
					<p><a href="#">信誉担保</a></p>
				...
				<ul class="footer_info_ul">
					<li>
						<h3><img src="<?php echo IMG_URL; ?>/icon/zhifu.jpg" alt="zhifu" class="img-circle foot_img" height="20" width="20">支付方式</h3>
					</li>
					<p><a href="#">网上银行</a></p>
					<p><a href="#">支付宝</a></p>
					<p><a href="#">邮政汇款</a></p>
				...
				<ul class="footer_info_ul border_none">
					<li>
						<h3><img src="<?php echo IMG_URL; ?>/icon/fuwu.jpg" alt="fuwu" class="img-circle foot_img" height="20" width="20">售后服务</h3>
					</li>
					<p><a href="#">退款退货</a></p>
					<p><a href="#">投诉维权</a></p>
					<p><a href="#">举报管理</a></p>
	...
	<script type="text/javascript" src="<?php echo JS_URL; ?>/jquery.validate-1.13.1.js"></script>
